"""
Flask routes and utility functions for help pages, settings pages, and notification emails.

This module defines Flask routes to display help and settings pages for logged-in users, 
and a function to send notification emails using Flask-Mail.

Dependencies:
- Flask: Web framework for Python.
- render_template: Function to render HTML templates.
- Blueprint: Organizational unit for Flask routes.
...
- MAIL: Instance of Flask-Mail for sending emails.
- logging: Python's logging module for logging events.

Routes:
- /help: Displays the help page (help.html) for logged-in users.
- /settings: Displays the settings page (settings.html) for logged-in users.
"""
